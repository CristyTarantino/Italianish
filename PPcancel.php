...
<section id="content">
  <div id="main-content">
    <article id="fullsize">
      ...
      <div class="content">
        <div>
        <p>We are sorry to see that you have cancelled the transaction.</p> 
	<p><a href="index.php"><input class="button" name="continue" type="button" value="Click to Continue Shopping"></a></p>
        </div>
      </div>
    </article>
  </div>
