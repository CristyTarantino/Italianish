	...
	if(isset($_GET['pageID']))
	  {
		...
		$rsPages = mysql_query($query_rsPages, $mctarant_assignment_2012) or die(mysql_error()); 
...
<?php include("includes/headerHTML.incl.php") ?>
		<article id="fullsize">
			...
			<div class="content">
                ...
                <ul>
                <li><a href="http://www.mctarantino.com/projects/Recipejack.zip">Assignment Zip File</a> </li>
                ...
                <li><a href="http://italianish.co.uk/Dynamic%20Course/dashboard/dbdIndex.php">My Blackjack Gallery</a></li>
                <li><a href="http://www.headroomgate.co.uk/dynamic/assignment/SA1onlineTemplate.doc">SA1 assignment cover sheet</a> </li>
                </ul>
                </div>       
            </div>
		</article>	
