...
<?php 
	if(isset($_POST['confirm']) && $_POST['orderNumber'] > 0){
		...
		This mail is to confirm that your order No.'.$orderNumber.' has been received.
...
?>
    ...
    <form action="" method="post">
      ...
      <input class="button" id="confirm" name="confirm" type="submit" value="Confirm Order Paid">
